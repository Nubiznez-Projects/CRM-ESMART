...
const handleFileChange = async (event) => {
  ...
  const fetchBusiness = async () => {
    try {
      ...
      setprofileImg(data?.business?.ProfileImage);
              ...
              <div className="relative">
                ...
                {!isEdit ?
                 <button
                  ...
                  className="absolute cursor-pointer -bottom-[3vw] right-[0.2vw] bg-black text-white px-3 py-1 rounded-md text-[0.9vw] flex items-center gap-[0.3vw]"
                >
                  <MdEdit size={"1vw"} />
                  EDIT
                </button>
                : <button
                  ...
                  className="absolute cursor-pointer -bottom-[3vw] font-bold right-[0.2vw] bg-white text-black border-[0.1vw] border-black px-3 py-1 rounded-md text-[0.9vw] flex items-center gap-[0.3vw]"
                >
                  CANCEL
                </button>
                }
