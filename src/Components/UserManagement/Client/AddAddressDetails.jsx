...
export const AddAddressDetails = ({
  ...
  useEffect(() => {
    if (clientData?.address?.country) {
      setSelectedCountry(clientData?.address?.country);
    }
    if (clientData?.address?.state) {
      setSelectedState(clientData?.address?.state);
    }
  }, [clientData]);
            ...
            <div className="grid grid-cols-2 gap-[2vw] mt-[2vw]">
              ...
              <div>
                ...
                <div className="relative">
                  <Field
                    as="select"
                    disabled={action === "view" || !selectedCountry}
                    id="state"
                    name="state"
                    value={selectedState}
                    onChange={(e) => {
              ...
              <div>
                ...
                <div className="relative">
                  <Field
                    as="select"
                    disabled={action === "view" || !selectedState}
                    id="city"
                    name="city"
                    className="w-full h-[2vw] border border-gray-300 rounded px-[0.3vw] py-[0.2vw] text-[0.9vw] bg-white"
                  >
