        ...
        return (
          <div className="flex justify-center items-center text-[0.85vw]">
            ...
            {isCurrentPopoverOpen && (
              <div className="status-dropdown-content absolute z-10 mt-[6.4vw] w-[7vw] bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
      ...
      render: (row) => {
        ...
        return (
          <div className="flex justify-center items-center text-[0.85vw]">
            ...
            {isCurrentPopoverOpen && (
              <div className="status-dropdown-content absolute z-10 mt-[6.3vw] w-[7vw] bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div className="py-[0.4vw]">
