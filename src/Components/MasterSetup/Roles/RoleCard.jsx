        ...
        <div className="relative flex flex-col">
          <div className="flex mt-[1vw] gap-[1.7vw]">
            {visibleCards?.map((card, index) => (
              ...
              >
                <div className="grid grid-cols-4 p-[0.1vw]">
                  ...
                  <div className="col-span-2 flex flex-nowrap gap-1">
                    <div className="flex ml-[0.1vw]">
                    <div className="flex justify-end mr-2">
                        <img className="border-2 border-white dark:border-gray-800 rounded-full h-7 w-7 -mr-2"
                            src="https://randomuser.me/api/portraits/men/44.jpg" alt=""/>
                        <img className="border-2 border-white dark:border-gray-800 rounded-full h-7 w-7 -mr-2"
                            src="https://randomuser.me/api/portraits/women/42.jpg" alt=""/>
                        <span
                            className="flex items-center justify-center py-auto bg-white dark:bg-gray-800 text-[0.7vw]
                             text-gray-800 dark:text-white font-bold border-2 border-gray-200 dark:border-gray-700 rounded-full h-7 w-7">
                            +9  
                        </span>
                        <span className="text-[0.7vw] text-center my-auto mx-[0.4vw]">Users</span>
                    </div>
                  </div>
                    <Popover
                      key={card.RoleId}
                      ...
                      overlayInnerStyle={{ backgroundColor: "#F9F6EB", borderColor:"black", borderWidth:"0.15vw", width:"5vw" }}
                      content={
